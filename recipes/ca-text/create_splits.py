...
for word_file in tqdm(words_files):
    train_file_path = os.path.basename(word_file).replace('.txt', f'_train_{word_file_id}.lex')
    test_file_path = os.path.basename(word_file).replace('.txt', f'_test_{word_file_id}.lex')
